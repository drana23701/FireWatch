...
on second call determined by the `force` parameter.
        ...
        if self.data_prepared and not force:
            ...
            self.data = ModelDataset(forecast_dir=self.hparams.forecast_dir, forcings_dir=self.hparams.forcings_dir, reanalysis_dir=self.hparams.reanalysis_dir, frp_dir=self.hparams.frp_dir, hparams=self.hparams, out=self.hparams.out)
